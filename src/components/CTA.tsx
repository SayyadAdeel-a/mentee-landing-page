...
export function CTA() {
  return (
    <section className="relative mx-auto max-w-7xl px-6 py-24 bg-white text-neutral-950">
      <div className="relative overflow-hidden rounded-3xl border border-[#333333] bg-[#212121] px-8 py-20 text-center shadow-2xl text-white">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              href="/contact"
              className="flex items-center gap-2 rounded-full border border-[#444444] bg-[#2a2a2a] px-7 py-3.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-[#333333] hover:border-[#555555] active:scale-95"
            >
          ...
          <div className="mt-12 flex flex-wrap items-center justify-center gap-8 text-xs font-mono text-neutral-400 border-t border-[#333333] pt-8">
