  ...
  return (
    <section id="products" className="relative mx-auto max-w-7xl px-6 py-24 bg-white text-neutral-950">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* 1. RecruAI */}
        <SpotlightCard className="flex flex-col justify-between p-7 rounded-3xl border border-neutral-200 bg-neutral-50/70 shadow-xs">
          ...
          <div className="flex h-12 items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-bold text-neutral-950">RecruAI</h3>
                <span className="text-[10px] font-mono font-bold uppercase text-neutral-700 bg-white border border-neutral-200 px-2 py-0.5 rounded-full">
                  Talent Engine
                </span>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between border-b border-neutral-100 pb-2.5">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-neutral-500 font-mono">Autonomous Profile Evaluation</p>
                  </div>
                </div>
                <div className="text-right">
                  <span className="text-base font-black text-emerald-600 font-mono">{matchScore}%</span>
                  <p className="text-[9px] text-neutral-500 uppercase tracking-wider font-semibold">Fit Index</p>
                </div>
              </div>
              <div className="mt-2.5 grid grid-cols-3 gap-2 text-[10px]">
                <div className="rounded-lg bg-neutral-50 p-2 border border-neutral-200">
          ...
          <div className="flex h-11 items-center justify-between border-t border-neutral-200/80 pt-1 text-xs">
            <span className="text-neutral-500 font-mono text-[11px]">FastAPI · PostgreSQL · Vector Search</span>
            <Link
              href="/products"
        ...
        <SpotlightCard className="flex flex-col justify-between p-7 rounded-3xl border border-neutral-200 bg-neutral-50/70 shadow-xs">
          ...
          <div className="flex h-12 items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-bold text-neutral-950">DocsBox</h3>
                <span className="text-[10px] font-mono font-bold uppercase text-neutral-700 bg-white border border-neutral-200 px-2 py-0.5 rounded-full">
                  Zero-Knowledge
                </span>
              </div>
          ...
          {/* Enforced Anatomy: Footer 44px pinned bottom */}
          <div className="flex h-11 items-center justify-between border-t border-neutral-200/80 pt-1 text-xs">
            <span className="text-neutral-500 font-mono text-[11px]">Kotlin · AES-256 · Firebase</span>
            <Link
              href="/products"
              className="flex items-center gap-1 text-xs font-bold text-neutral-950 hover:text-neutral-700 focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:outline-none rounded-md py-1 transition-colors"
            >
        ...
        <SpotlightCard className="flex flex-col justify-between p-7 rounded-3xl border border-neutral-200 bg-neutral-50/70 shadow-xs">
          ...
          <div className="flex h-12 items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-bold text-neutral-950">DataFit</h3>
                <span className="text-[10px] font-mono font-bold uppercase text-neutral-700 bg-white border border-neutral-200 px-2 py-0.5 rounded-full">
                  PyPI Package
                </span>
              </div>
          ...
          {/* Enforced Anatomy: Footer 44px pinned bottom */}
          <div className="flex h-11 items-center justify-between border-t border-neutral-200/80 pt-1 text-xs">
            <span className="text-neutral-500 font-mono text-[11px]">Python 3.10+ · Scikit-Learn · Pandas</span>
            <a
        ...
        <SpotlightCard className="flex flex-col justify-between p-7 rounded-3xl border border-neutral-200 bg-neutral-50/70 shadow-xs">
          ...
          <div className="flex h-12 items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <h3 className="text-lg font-bold text-neutral-950">Vision Systems</h3>
                <span className="text-[10px] font-mono font-bold uppercase text-neutral-700 bg-white border border-neutral-200 px-2 py-0.5 rounded-full">
                  Edge AI
                </span>
              </div>
          ...
          <div className="flex-1 flex flex-col justify-between my-5">
            ...
            <div className="overflow-hidden rounded-xl border border-neutral-800 bg-[#111113] p-4 text-white font-mono shadow-md">
              ...
              <div className="rounded-lg bg-[#18181b] p-3 border border-neutral-800 flex flex-col justify-between h-20">
          ...
          {/* Enforced Anatomy: Footer 44px pinned bottom */}
          <div className="flex h-11 items-center justify-between border-t border-neutral-200/80 pt-1 text-xs">
            <span className="text-neutral-500 font-mono text-[11px]">OpenCV · YOLOv8 · TensorRT</span>
            <Link
              href="/products"
              className="flex items-center gap-1 text-xs font-bold text-neutral-950 hover:text-neutral-700 focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:outline-none rounded-md py-1 transition-colors"
            >
